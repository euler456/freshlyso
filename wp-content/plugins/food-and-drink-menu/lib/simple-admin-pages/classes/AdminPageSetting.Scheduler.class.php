...
class sapAdminPageSettingScheduler_2_0_a_7 extends sapAdminPageSetting_2_0_a_7 {
	...
	public function display_setting() {
		...
		<fieldset>
			...
			<div class="sap-add-scheduler <?php echo ( $this->disabled ? 'disabled' : ''); ?>">
				<a href="#" class="button">
					<?php _e( 'Add new scheduling rule', 'food-and-drink-menu' ); ?>
				</a>
			</div>
		...
		<div class="sap-scheduler-rule clearfix<?php echo $list ? ' list' : ''; ?>">
			<div class="sap-scheduler-date <?php echo $date_format; echo $this->disable_time === true ? ' full-width' : ''; ?>">
				...
				<?php if ( !$this->has_multiple_date_formats() ) : ?>
					<li>
						...
						<?php _ex( 'Weekly', 'Format of a scheduling rule', 'food-and-drink-menu' ); ?>
						<?php elseif ( $date_format == 'monthly' ) : ?>
						<?php _ex( 'Monthly', 'Format of a scheduling rule', 'food-and-drink-menu' ); ?>
						<?php elseif ( $date_format == 'date' ) : ?>
						<?php _ex( 'Date', 'Format of a scheduling rule', 'food-and-drink-menu' ); ?>
						<?php endif; ?>
					</li>
				<?php else : ?>
				...
				<ul class="sap-scheduler-weekdays">
					<li class="label">
						<?php _ex( 'Days of the week', 'Label for selecting days of the week in a scheduling rule', 'food-and-drink-menu' ); ?>
					</li>
				<?php
				...
				<ul class="sap-scheduler-weeks">
					<li class="label">
						<?php _ex( 'Weeks of the month', 'Label for selecting weeks of the month in a scheduling rule', 'food-and-drink-menu' ); ?>
					</li>
				<?php
				...
				<div class="sap-scheduler-date-input">
					<label for="<?php echo $this->get_input_name(); ?>[<?php echo $id; ?>][date]">
						<?php _e( 'Date', 'food-and-drink-menu' ); ?>
					</label>
			...
			<div class="sap-scheduler-time <?php echo $time_format; ?>">
				...
				<ul class="sap-selector">
					<li>
						...
						<a href="#" data-format="time-slot"<?php echo $time_format == 'time-slot' ? ' class="selected"' : ''; ?>>
							<?php _ex( 'Time', 'Label to select time slot for a scheduling rule', 'food-and-drink-menu' ); ?>
						</a>
					</li>
					<li>
						<a href="#" data-format="all-day"<?php echo $time_format == 'all-day' ? ' class="selected"' : ''; ?>>
							<?php _ex( 'All day', 'Label to set a scheduling rule to last all day', 'food-and-drink-menu' ); ?>
						</a>
					</li>
				</ul>
				...
				<div class="sap-scheduler-time-input clearfix">
					...
					<div class="start">
						<label for="<?php echo $this->get_input_name(); ?>[<?php echo $id; ?>][time][start]">
							<?php _ex( 'Start', 'Label for the starting time of a scheduling rule', 'food-and-drink-menu' ); ?>
						</label>
					...
					<div class="end">
						<label for="<?php echo $this->get_input_name(); ?>[<?php echo $id; ?>][time][end]">
							<?php _ex( 'End', 'Label for the ending time of a scheduling rule', 'food-and-drink-menu' ); ?>
						</label>
				...
				<div class="sap-scheduler-all-day">
					<?php _ex( 'All day long. Want to <a href="#" data-format="time-slot">set a time slot</a>?', 'Prompt displayed when a scheduling rule is set without any time restrictions.', 'food-and-drink-menu' ); ?>
				</div>
			...
			<div class="sap-scheduler-control">
				<a href="#" class="toggle" title="<?php _e( 'Open and close this rule', 'food-and-drink-menu' ); ?>">
					<div class="dashicons dashicons-<?php echo $list ? 'edit' : 'arrow-up-alt2'; ?>"></div>
					<span class="screen-reader-text">
						<?php _e( 'Open and close this rule', 'food-and-drink-menu' ); ?>
					</span>
				</a>
				<a href="#" class="delete" title="<?php _e( 'Delete rule', 'food-and-drink-menu' ); ?>">
					<div class="dashicons dashicons-dismiss"></div>
					<span class="screen-reader-text">
						<?php _e( 'Delete scheduling rule', 'food-and-drink-menu' ); ?>
					</span>
				</a>
			</div>
		</div>
	...
	public function set_schedule_summaries() {
		...
		$this->schedule_summaries = array(
			...
			'separator'				=> _x( '&mdash;', 'Default separator between times of a scheduling rule.', 'food-and-drink-menu' ),
		);
