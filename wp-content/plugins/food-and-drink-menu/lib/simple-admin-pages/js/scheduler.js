	 ...
	 ***********/
	 ...
	 if ( typeof sap_scheduler != 'undefined' ) {
		...
		function sap_scheduler_register_events() {
			 ...
			 */
			$( '.sap-scheduler-rule .toggle' ).off( 'click.toggleRule' ).on( 'click.toggleRule', function() {
			 ...
			 */
			$( '.sap-scheduler-date .sap-selector a' ).off( 'click.toggleView' ).on( 'click.toggleView', function() {
			 ...
			 */
			$( '.sap-scheduler-time .sap-selector a' ).off( 'click.toggleTime' ).on( 'click.toggleTime', function() {
			 ...
			 */
			$( '.sap-scheduler-all-day a' ).off( 'click.toggleSlotOptions' ).on( 'click.toggleSlotOptions', function() {
			 ...
			 */
			$( '.sap-scheduler-control .delete' ).off( 'click.deleteRule' ).on( 'click.deleteRule', function() {
