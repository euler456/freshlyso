...
```
	...
	$sap->add_page(
		...
		array(					// Array of key/value pairs matching the AdminPage class constructor variables
			'id'			=> 'basic-settings',
			'title'			=> __( 'Page Title', 'food-and-drink-menu' ),
			'menu_title'	=> __( 'menu Title', 'food-and-drink-menu' ),
			'description'	=> '',
	...
	$sap->add_section(
		...
		array(					// Array of key/value pairs matching the AdminPageSection class constructor variables
			'id'			=> 'basic-details',
			'title'			=> __( 'Basic Details', 'food-and-drink-menu' ),
			'description'	=> __( 'This section includes some basic details for you to configure.', 'food-and-drink-menu' )
		)
	);
	...
	$sap->add_setting(
		...
		array(
			'id'			=> 'select-field',
			'title'			=> __( 'Select Field', 'food-and-drink-menu' ),
			'description'	=> __( 'A demonstration of the select field type.', 'food-and-drink-menu' ),
			'options'		=> array(
				'one' 	=> __( 'Option 1', 'food-and-drink-menu' ),
				'two' 	=> __( 'Option 2', 'food-and-drink-menu' ),
				'three' => __( 'Option 3', 'food-and-drink-menu' )
			)
		)
	);
...
$sap->add_section(
	...
	$args = array(
		'id'            => 'tab-one',
		'title'         => __( 'Tab One', 'food-and-drink-menu' ),
		'description'   => __( 'This tab includes some settings for you to configure.', 'food-and-drink-menu' ),
		'is_tab'		=> true,
	)
);
...
$sap->add_section(
	...
	$args = array(
		...
		'title'         => __( 'Section One', 'food-and-drink-menu' ),
		'description'   => __( 'This section includes some settings for you to configure.', 'food-and-drink-menu' ),
		'tab'			=> 'tab-one',
	)
);
```
...
$sap->add_setting(
	...
	array(
		'id'            => 'my-first-setting',
		'title'         => __( 'My First Setting', 'food-and-drink-menu' ),
		'description'	=> __( 'A demonstration of my first setting', 'food-and-drink-menu' );
		...
	)
);
```
