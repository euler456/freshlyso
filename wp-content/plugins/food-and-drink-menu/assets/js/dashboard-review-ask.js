jQuery(document).ready(function($) {
  ...
  jQuery(document).on('click', '.fdm-main-dashboard-review-ask .notice-dismiss', function(event) {
    var data = 'ask_review_time=7&action=fdm_hide_review_ask';
	...
	jQuery('.fdm-review-ask-not-really').on('click', function() {
		...
		var data = 'ask_review_time=1000&action=fdm_hide_review_ask';
        jQuery.post(ajaxurl, data, function() {});
	});
	...
	jQuery('.fdm-review-ask-send-feedback').on('click', function() {
		...
		var data = 'feedback=' + feedback + '&email_address=' + email_address + '&action=fdm_send_feedback';
        jQuery.post(ajaxurl, data, function() {});
