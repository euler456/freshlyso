jQuery(document).ready(function() {
	...
	jQuery( '#fdm-ordering-sidescreen-close' ).on( 'click', function() {
	...
	jQuery( '#fdm-order-submit-button' ).on( 'click', function() {
		...
		var data = 'permalink=' + permalink + '&name=' + name + '&email=' + email + '&phone=' + phone + '&note=' + note + '&action=fdm_submit_order';
		jQuery.post( ajaxurl, data, function( response ) {
...
function fdm_update_cart_quantities() {
	...
	jQuery( '.fdm-cart-menu-item' ).each(function () {
		data['quantity'][jQuery(this).data( 'postid' )] = jQuery(this).find('.fdm-item-quantity-wrapper input').val();
	});
