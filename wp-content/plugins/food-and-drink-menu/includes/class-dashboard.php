...
class fdmDashboard {
	...
	public function enqueue_scripts() {
		if ( isset( $_GET['post_type'] ) and ( $_GET['post_type'] == FDM_MENU_POST_TYPE or $_GET['post_type'] == FDM_MENUITEM_POST_TYPE ) ) {
		...
		<div id="fdm-dashboard-content-area">
			...
			<div id="fdm-dashboard-content-left">
				...
				<?php if ( sizeOf( $menus ) == 0 and sizeOf( $menu_items ) == 0 ) { ?>
					<div class="fdm-dashboard-new-widget-box ewd-widget-box-full fdm-admin-closeable-widget-box" id="fdm-dashboard-restart-walkthrough-widget-box">
				...
				<?php if ( ! $permission or get_option("FDM_Trial_Happening") == "Yes") {
					$premium_info = '<div class="fdm-dashboard-new-widget-box ewd-widget-box-full">';
					...
					echo apply_filters( 'fsp_dashboard_top', $premium_info, 'FDM', 'https://www.fivestarplugins.com/license-payment/?Selected=FDM&Quantity=1' );
				} ?>
		
				<div class="fdm-dashboard-new-widget-box ewd-widget-box-full" id="fdm-dashboard-support-widget-box">
					...
					<div class="fdm-dashboard-new-widget-box-bottom">
						<ul class="fdm-dashboard-support-widgets">
							...
							<li>
								<a href="http://doc.fivestarplugins.com/plugins/food-and-drink-menu/" target="_blank">
				...
				<div class="fdm-dashboard-new-widget-box ewd-widget-box-full" id="fdm-dashboard-optional-table">
				...
				<?php /*<div class="fdm-dashboard-new-widget-box <?php echo ( ($hideReview != 'Yes' and $Ask_Review_Date < time()) ? 'ewd-widget-box-two-thirds' : 'ewd-widget-box-full' ); ?>">
				...
				<?php /* if($hideReview != 'Yes' and $Ask_Review_Date < time()){ ?>
					<div class="fdm-dashboard-new-widget-box ewd-widget-box-one-third">
				...
				<?php if ( ! $permission or get_option("FDM_Trial_Happening") == "Yes" ) { ?>
					<div class="fdm-dashboard-new-widget-box ewd-widget-box-full" id="fdm-dashboard-guarantee-widget-box">
			...
			<div id="fdm-dashboard-content-right">
				...
				<?php if ( ! $permission or get_option("FDM_Trial_Happening") == "Yes" ) { ?>
					<div class="fdm-dashboard-new-widget-box ewd-widget-box-full" id="fdm-dashboard-get-premium-widget-box">
						<div class="fdm-dashboard-new-widget-box-top">Get Premium</div>
						
						<?php if ( get_option( "FDM_Trial_Happening" ) == "Yes" ) { do_action( 'fsp_trial_happening', 'BPFWP' ); } ?> 

						<div class="fdm-dashboard-new-widget-box-bottom">
							<div class="fdm-dashboard-get-premium-widget-features-title"<?php echo ( get_option("FDM_Trial_Happening") == "Yes" ? "style='padding-top: 20px;'" : ""); ?>>GET FULL ACCESS WITH OUR PREMIUM VERSION AND GET:</div>
							...
							<a href="https://www.fivestarplugins.com/license-payment/?Selected=FDM&Quantity=1" class="fdm-dashboard-get-premium-widget-button" target="_blank">UPGRADE NOW</a>
							
							<?php if (!get_option("FDM_Trial_Happening")) { 
								...
								echo apply_filters( 'fsp_trial_button', $trial_info, 'FDM' );
							} ?>
				</div>
					</div>
				<?php } ?>

				<div class="fdm-dashboard-new-widget-box ewd-widget-box-full">
					<div class="fdm-dashboard-new-widget-box-top">Other Plugins by Five Star</div>
					<div class="fdm-dashboard-new-widget-box-bottom">
						<ul class="fdm-dashboard-other-plugins">
							<li>
								<a href="https://wordpress.org/plugins/restaurant-reservations/" target="_blank"><img src="<?php echo plugins_url( '../assets/img/rtb-icon.png', __FILE__ ); ?>"></a>
		...
		<div id="fdm-dashboard-new-footer-two">
			<div class="fdm-dashboard-new-footer-two-inside">
				...
				<ul class="fdm-dashboard-new-footer-two-menu">
					...
					<li><a href="http://doc.fivestarplugins.com/plugins/food-and-drink-menu/" target="_blank">Documentation</a></li>
